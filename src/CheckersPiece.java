 ...
 * This is the class that contains individual piece logic checkers
 * board. 
 * 
 * @version 1.0
 */
public class CheckersPiece {
	...
	/**
	 * Simple to string method that converts various values to string
	 * in order to display status.
	 */
